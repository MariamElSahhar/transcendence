...
export class ResetPasswordPage extends Component {
	...
	render() {
		return (`
			<div id="reset-password-page">
				...
				<div id="container">${this.#renderCurrentComponent()}</div>
			</div>
		`);
	}
	...
	#loadComponent() {
		...
		if (this.currentStep === 'email') {
			const emailComponent = container.querySelector('reset-password-email-component');
			...
			const codeComponent = container.querySelector('reset-password-code-component');
			...
			const newPasswordComponent = container.querySelector('reset-password-new-component');
