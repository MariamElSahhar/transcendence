...
export class NotificationNav extends Component {
	...
	#toggleNotification() {
		if (
			this.notificationComponent.notifications.length === 0 ||
	...
	async addNotification(notification) {
		...
		const currentCount = this.bellIcon.getAttribute("data-count")
			? parseInt(this.bellIcon.getAttribute("data-count"))
			: 0;
      ...
      <div class="d-flex justify-content-start align-items-center">
          <div class="d-flex align-items-center mb-1">
              ...
              <p class="mb-0 text-muted" style="font-size: 0.8rem;">
                  <a class="text-primary text-decoration-none" onclick="window.redirect('${profileUrl}')">${username}</a>
      ...
      <div class="d-flex justify-content-start align-items-center">
          ...
          <div class="me-2">
           <i class="bi bi-trophy-fill rounded-circle fs-3" ></i>
              ...
              <p class="mb-0 text-muted" style="font-size: 0.8rem;">
                  Tournament
                  <a class="text-primary text-decoration-none" onclick="window.redirect('/game/${notification.data}/')">${notification.title}</a>
                  has started
              </p>
          </div>
      </div>
	...
	#joinTournament(notification) {
		this.removeNotification(notification);
		window.redirect(`/game/${notification.data}/`);
	}
