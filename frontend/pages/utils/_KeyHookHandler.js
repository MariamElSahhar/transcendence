export class _KeyHookHandler {
    ...
    stopListeningForKeyHooks() {
      this.#engine.component.removeComponentEventListener(window, 'keydown');
      this.#engine.component.removeComponentEventListener(window, 'keyup');
      this.#engine.component.removeComponentEventListener(window, 'blur');
  
      const canvas = this.#engine.component.querySelector('canvas');
      this.#engine.component.removeComponentEventListener(canvas, 'touchstart');
      this.#engine.component.removeComponentEventListener(canvas, 'touchend');
    }
